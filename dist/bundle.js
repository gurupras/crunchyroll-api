...
const videoIDRegex = /https?:\/\/.*?\.crunchyroll\.com\/watch\/([a-zA-Z0-9_]+)(\/.*)?/g
...
module.exports = class NewEpisode extends Episode {
  async parse () {
    ...
    if (!match) {
      console.error(`Failed to match url: ${this.url}`)
    }
